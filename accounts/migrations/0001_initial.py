# Generated by Django 3.0 on 2020-08-08 11:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('header_eventimage', models.ImageField(blank=True, null=True, upload_to=accounts.models.user_directory_path)),
                ('footer_eventimage', models.ImageField(blank=True, null=True, upload_to=accounts.models.user_directory_path)),
                ('streaming_header', models.ImageField(blank=True, null=True, upload_to=accounts.models.user_directory_path)),
                ('streaming_leftpanel', models.ImageField(blank=True, null=True, upload_to=accounts.models.user_directory_path)),
                ('streaming_rightpanel', models.ImageField(blank=True, null=True, upload_to=accounts.models.user_directory_path)),
