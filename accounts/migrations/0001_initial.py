# Generated by Django 3.0 on 2020-08-09 21:17
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('header_eventimage', models.ImageField(blank=True, null=True, upload_to='images')),
                ('footer_eventimage', models.ImageField(blank=True, null=True, upload_to='images')),
                ('streaming_header', models.ImageField(blank=True, null=True, upload_to='images')),
                ('streaming_leftpanel', models.ImageField(blank=True, null=True, upload_to='images')),
                ('streaming_rightpanel', models.ImageField(blank=True, null=True, upload_to='images')),
